              ...
              child: Container(
                ...
                child: Column(children: [
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(icon: jm_naviBack_icon, onPressed: (){
                        Navigator.pop(context);
                      }),
                      jm_naviTitle('PK赛'),
                      IconButton(icon: jm_naviAdd_icon, onPressed: (){
                        Navigator.pop(context);
                      }),
                    ],
                  )
            ...
            Positioned(
              ...
              ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index){
                  return PKmainListCell(cellData: pkListData[index],index: index, cellClick: cellClick,);
                },
              ),)
            )
          ],),))
